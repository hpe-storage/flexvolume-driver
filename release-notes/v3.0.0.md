...
The release notes describe the major changes, fixes, and known issues for this release of the new for HPE Volume Driver for Kubernetes FlexVolume Plugin 3.0.0. They do not include all individual fixes and internal changes.
